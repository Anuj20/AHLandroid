...
public class EditLICPolicyFragment extends Fragment {
   ...
   public static String Name, PolicyNo, PremiumAmt, PremiumDate, UserId, PremiumMode,Policy_Id;
    Button btnAddPolicy;
    Calendar myCalendar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(TextUtils.equals(PremiumMode,"12")){
            rdbYearly.setChecked(true);
        }else  if(TextUtils.equals(PremiumMode,"6")){
            rdbHalfYearly.setChecked(true);
        }else  if(TextUtils.equals(PremiumMode,"3")){
            rdbQtr.setChecked(true);
        }
    ...
    public void UodatePolicy() {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                try {
                    String PolicyParameter = "api_edit_lic_policy.php?name=" + Name + "&policy_id=" + Policy_Id + "&policy_no=" + PolicyNo + "&premium_amount=" + PremiumAmt + "&premium_due_date=" + PremiumDate + "&premium_mode=" + PremiumMode;
